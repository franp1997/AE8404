...
X <- DT$V1 |> sort()
summary(X)
hist(X, main="Default",col = "seagreen2",labels = TRUE,freq=FALSE)
```
...
hist(X,breaks=BRK, main="a)", col = "rosybrown", labels = TRUE,freq=FALSE)
```
...
hist(X,breaks=BRK,main=NULL, col = "rosybrown", labels = TRUE,freq=FALSE)
```

c.  De 24 a 134 con un paso de 10  
```{r }
BRK <- seq(from=24,to=134,by=10)
hist(X,breaks=BRK, main="c)", col = "rosybrown", labels = TRUE,freq=FALSE)
```
...
hist(X,breaks=BRK,main="", col = "plum", labels = TRUE,freq=FALSE)
```

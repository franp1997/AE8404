...
```{r}
#if(getOutputFormat() %in% c('html_document','bookdown::gitbook')) {
...
_La función `cor()` permite estimar la correlación entre dos vectores que para este caso resulta `cor(X1,X2) =` `r cor(X1,X2)`. Los vectores $X_1$ y $X_2$ son realizaciones de una muestra aleatoria con distribución uniforme y no deberían tener ninguna correlación como se puede ver en el gráfico de dispersión._
